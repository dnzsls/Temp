...
def optimize_queue(erlang_by_slot, df_shifts, queue,
    ...
    # Start smoothing — sadece AKTİF saatler arasında ceza uygular.
    # yh[h] = "h saatinde en az bir shift aktif mi" binary göstergesi.
    # İki ardışık saat de aktifse diff cezası devreye girer; biri 0 ise slack
    # (M * (2 - yh_prev - yh_curr)) cezayı sıfırlar.
