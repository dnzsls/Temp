# =============================================================================
# KUYRUK BAZLI VARDIYA PİPELİNE - ACTUAL V5 (WEEKDAY)
# =============================================================================
#
# V5 (sadece HAFTAİÇİ):
#   V4 üzerine kurulu, tek fark:
#
#   1) MIN_PER_SHIFT FALLBACK:
#      - optimize_queue infeasible döndürdüğünde min_per_shift azaltılarak yeniden denenir
#      - Config'te min_per_shift_fallback.enabled=True ise
#        default değerden 'floor' değerine kadar 'step' aralığıyla düşürülerek denenir
#      - min_per_shift_overrides (saat-özel) değişmez, sadece default ezilir
#
#   V4'ten kalan özellikler (değişmedi):
#   - Pencere bazlı balans penalty
#   - Surplus dağıtımı (inhouse + outsource)
#   - Start smoothing (ardışık aktif komşu saatler, bridge-binary)
#
#   Config: config_v5_weekday.py kullanın.
#
# =============================================================================
...
def optimize_queue(erlang_by_slot, df_shifts, queue,
    ...
    """
    V5 MIP — eşit maliyet + pencere bazlı balans penalty.
