...
# =============================================================================
#
# V6 (sadece HAFTAİÇİ) — V5 üzerine TEK DEĞİŞİKLİK:
#
#   1) PENCERE BAZLI START SMOOTHING:
#      - Eski: start_smoothing tek bir 'hours' aralığı + tek bir
#        'penalty_per_diff' değeri kullanıyordu. Bu, MIP'i sık sık tüm
#        vardiyaları min_per_shift (örn. 13) seviyesine fixleme noktasına
#        itiyordu (her vardiya eşit → fark sıfır → ceza yok).
#      - Yeni: 'windows' listesi — her pencere kendi başlangıç-bitiş saati
#        ve kendi 'penalty_per_diff' değeri ile config edilir. Smoothing
#        yalnızca aynı pencere içindeki ardışık aktif başlangıç saatleri
#        arasında uygulanır; pencereler arası fark cezasız bırakılır.
#      - Geriye uyumluluk: 'windows' yoksa eski format (tek hours+penalty)
#        kullanılır.
#
#   V5'ten kalan TÜM özellikler değişmedi (min_per_shift fallback, balance
#   penalty, surplus dağıtımı, rr_penalty, small_shift_penalty, slot_cap).
#
